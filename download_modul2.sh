...
echo " "
echo "                      *******************************************"
echo "                     Download data praktikum, jangan sampai ketinggalan,"
echo "                       Tunggu dengan sabar, sambil baca komik Batman,"
echo "                          Ngopi secangkir, bikin mata jadi segar"
echo "                          Jangan dicancel, atau kita jadi gundar!"
echo " "
echo "                                BTW SIZE DATANYA 500 mb"
echo "                     PASTIKAN SINYAL KAMU KUENCENG & STORAGE KAMU MASIH!!!"
echo " "
echo "                       *******************************************"
echo " "
echo "================================================================================="
