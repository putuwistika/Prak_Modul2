...
echo "${BRed}=======================================================================================================================${Color_Off}"
echo " "
echo "                              ${BBlue} ASISTEN PRAKTIKUM MPCN 2 2024 BERSAMA KALIAN ${Color_Off}"
echo " "
echo " ${BCyan}                              *******************************************"
...
echo " "
echo "                          @SALAM HANGAT ASISTEN PRAKTIKUM MPCN 2 2024 ALA ALA DUM DUM"
